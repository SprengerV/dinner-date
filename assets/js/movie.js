...
// const genresURL = 'https://api.themoviedb.org/3/genre/movie/list?api_key=' + movAPIkey + '&page=2'
// let genreID = '10751'
// const discover = 'https://api.themoviedb.org/3/discover/movie?api_key=' + movAPIkey + ''

// $(window).on('load', function(){
//     $.get(genresURL).then(function(response){
